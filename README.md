...
장면 전환 기준점(scene anchor)을 먼저 찾고, 그 주변의 OCR 단서와 오디오 단서, 블랙 화면 단서를 함께 해석해 광고 구간 타임스탬프를 만듭니다. 무거운 모델을 사용해 광고인지 아닌지 판단하는 방식이 아닌, 규칙 기반으로 광고 시작과 종료 경계를 찾는 데 초점을 두었습니다.
...
| 단순 오디오 음량 피쳐 추출 시, 광고 구간 설명력이 낮은 문제 | 단순 오디오 음량이 아닌 영상 전반의 오디오 흐름 대비 특정 구간의 오디오 흐름의 차이를 파악 | 오디오 피쳐 추출 고도화 | 상대적인 오디오 피쳐 변화를 파악 | 오디오 피쳐가 광고 탐지의 주요 단서로 활용하기 어렵다고 판단했습니다. |
|  |  |  |  |  |
